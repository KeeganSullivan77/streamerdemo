package com.streamer.demo.web.rest;

import com.streamer.demo.config.Constants;
import com.streamer.demo.StreamerdemoApp;
import com.streamer.demo.domain.Authority;
import com.streamer.demo.domain.User;
import com.streamer.demo.repository.AuthorityRepository;
import com.streamer.demo.repository.UserRepository;
import com.streamer.demo.security.AuthoritiesConstants;
import com.streamer.demo.service.MailService;
import com.streamer.demo.service.dto.UserDTO;
import com.streamer.demo.web.rest.errors.ExceptionTranslator;
import com.streamer.demo.web.rest.vm.KeyAndPasswordVM;
import com.streamer.demo.web.rest.vm.ManagedUserVM;
import com.streamer.demo.service.UserService;
...
@SpringBootTest(classes = StreamerdemoApp.class)
